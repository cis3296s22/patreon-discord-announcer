...
2) Copy the file config.json from the Github repo
3) If you do not have a personal discord bot setup, follow the instructions in the [Setup Discord Bot](#setup-discord-bot) section.
